...
AsciiWriter is not a full-fledged static site generator, it's a set of npm, JS, Gulpjs scripts that get you started with your own Asciidoctorjs based website. 
...
One such text markup language stands out as being consistant and also easy to use.
...
Asciidoctorjs is JS-version of it, AsciiWriter uses it to create html pages with Gulpjs.
...
AsciiWriter is for everyone who likes to write in plain text and can use command line. 
